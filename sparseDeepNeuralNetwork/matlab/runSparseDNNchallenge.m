...
inputFile = '~/graphchallenge/sparse-images-';
categoryFile = '~/graphchallenge/neuron';
layerFile = '~/graphchallenge/neuron';
...
for i=1:length(Nneuron)
  ...
  if READMAT
    load(['~/graphchallenge/sparse-images-' num2str(Nneuron(i)) '.mat'],'z');
    featureVectors = z;
  end
